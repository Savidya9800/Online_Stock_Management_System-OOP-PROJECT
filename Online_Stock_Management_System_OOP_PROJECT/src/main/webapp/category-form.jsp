			...
			<div class="card-body">
				<div class="modal">
					<div class="modal-content">
						<span class="close"><a href="category-list">&times;</a></span>
						<form action="${category != null ? 'updateCategory' : 'insertCategory'}"
							method="post">
							<caption>
							...
							<fieldset class="form-group">
								<label for="qty">Quantity in Store</label> <br> <input
									type="text" placeholder="Quantity in store"
									value="<c:out value='${category.qty}' />" id="qty"
									name="qty">
							</fieldset>

							<fieldset class="form-group">
								<label for="level">Recoder Level</label> <br> <input type="text"
									placeholder="Recoder level"
									value="<c:out value='${category.level}' />" id="level"
									name="level">
							</fieldset>
