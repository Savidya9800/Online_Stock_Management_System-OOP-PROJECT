	...
	<div class="container2">
		<div class="box">
			...
			<button type="button" class="button1">
				...
				<span class="button__text"><a href="new" class="btn-success">Add
						Customer</a></span>
			</button> 	
				...
				<tbody>
					<c:forEach var="customer" items="${listCustomer}">
						...
						<tr>
							...
							<td><a href="edit?id=<c:out value='${customer.id}' />"
								class="btn_E">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
								href="delete?id=<c:out value='${customer.id}' />" class="btn_D" onclick="return confirmDelete(${customer.id})">Delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
