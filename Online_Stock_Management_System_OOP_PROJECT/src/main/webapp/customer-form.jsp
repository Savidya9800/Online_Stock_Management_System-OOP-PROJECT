			...
			<div class="card-body">
				<div class="modal">
					<div class="modal-content">
						<span class="close"><a href="customer-list">&times;</a></span>
						<form action="${customer != null ? 'update' : 'insert'}"
							method="post">
							<caption>
								<h2>${customer != null ? 'Edit Customer' : 'Add New Customer'}</h2>
							</caption>
							...
							<fieldset class="form-group" style="margin-top: 20px;">
								<label for="name">Name</label> <br> <input type="text"
									...
									value="<c:out value='${customer.name}' />" id="name"
							...
							<fieldset class="form-group">
								<label for="address">Address</label> <br> <input
									...
									value="<c:out value='${customer.address}' />" id="address"
									name="address">
							</fieldset>

							<fieldset class="form-group">
								<label for="text">Email</label> <br> <input type="text"
									placeholder="ex: myname@example.com"
									value="<c:out value='${customer.email}' />" id="email"
									name="email">
							</fieldset>

							<fieldset class="form-group">
								<label for="phone">Contact</label> <br> <input type="tel"
									placeholder="+94 xx xxx xxxx"
									value="<c:out value='${customer.phone}' />" id="phone"
									name="phone">
							</fieldset>
