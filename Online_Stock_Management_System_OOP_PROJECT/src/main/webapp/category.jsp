	...
	<div class="container2">
		<div class="box">
			...
			<button type="button" class="button1">
				...
				<span class="button__text"><a href="newCategory" class="btn-success">Add
						Category</a></span>
			</button>
				...
				<tbody>
					<c:forEach var="category" items="${listCategory}">
						...
						<tr>
							...
							<td><c:out value="${category.qty}" /></td>
							<td><c:out value="${category.level}" /></td>
							<td><a href="editCategory?id=<c:out value='${category.id}' />"
								class="btn_E">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
								href="deleteCategory?id=<c:out value='${category.id}' />" class="btn_D"
								onclick="return confirmDelete(${category.id})">Delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
