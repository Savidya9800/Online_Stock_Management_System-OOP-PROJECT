            ...
            <div class="container col-md-5">
             ...
             <span class="close" ><a href="supplier-list">&times;</a></span>
						...
						<fieldset class="form-group">
                            ...
                            <br>
                            <input type="text" placeholder="address" value="<c:out value='${supplier.address}' />" id="address" name="address">
                        </fieldset>
                        
                        <fieldset class="form-group">
                            <label for="email">Email</label> 
                            <br>
                            <input type="text" placeholder="ex: myname@example.com" value="<c:out value='${supplier.email}' />" id="email" name="email">
                        </fieldset>

                        <fieldset class="form-group">
                            <label for="phone">Contact</label> 
                            <br>
                            <input type="tel" placeholder="+94 xx xxx xxxx" value="<c:out value='${supplier.phone}' />" id="phone" name="phone">
                        </fieldset>
